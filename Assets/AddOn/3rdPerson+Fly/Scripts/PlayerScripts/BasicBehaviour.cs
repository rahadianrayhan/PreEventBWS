...
public class BasicBehaviour : MonoBehaviour
{
	...
	[SerializeField] private bool isFOV;
	...
	void Update()
	{
		...
		switch (InputControl.CurrentType)
		{
			case InputControl.Type.joystick:
				h = AxisInput.GetAxis("Move_h");
				v = AxisInput.GetAxis("Move_v");
				break;
			case InputControl.Type.keyboard:
		...
		sprint = Input.GetButton(sprintButton) || isSprint;
		if (isFOV)
			SetFov();
